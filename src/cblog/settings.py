...
def get_ssm_parameters():
    ...
    username_param = ssm.get_parameter(Name='/yasin/capstone/username')
    password_param = ssm.get_parameter(Name="/yasin/capstone/password", WithDecryption=True)
...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.cm6sdmw70sor.us-east-1.rds.amazonaws.com',
        'PORT': '3306',
    }
}
...
AWS_STORAGE_BUCKET_NAME = 'capstone-yasin' # please enter your s3 bucket name
