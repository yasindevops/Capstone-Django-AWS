...
In the architecture, you can configure your infrastructure using the followings,
  ...
  - For RDS Database Instance;
    ...
    - Bonus!!!!! Database username and password will be retrieved from SSM Parameter Store and If you apply this option than you need to modify the "src/cblog/settings.py" according to SSM parameter. 
  ...
  - BONUS !!!!!! : 
    ...
    - Retrieving Database username and password via SSM Parameter Store (Note: If you apply this option than you need to modify the "src/cblog/settings.py" according to SSM parameter.) 
